        ...
        <div class="row">
          ...
          <div class="col-xs-6 col-md-3">
            ...
            <ul class="footer-links">
              ...
              <li>
                <a href="https://www.bookstack.cn/read/javascript-tutorial/docs-preface.md"
                  >JavaScript</a
                >
              </li>
              <li>
              ...
              <li>
                <a href="http://v4.iviewui.com/">ViewU</a>
              </li>
              <li>
                <a href="https://www.webpackjs.com/guides/">Webpack</a>
              </li>
            </ul>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <ul class="social-icons">
              <li>
                <a class="linkedin" href="https://github.com/doublewater777"><img src="../assets/github.svg"> </a>
              </li>
               <li>
                <a class="linkedin" href="https://juejin.cn/user/2331420885001271"><img src="../assets/blog.svg"> </a>
              </li>
              <li>
                <a class="github" href="https://weibo.com/u/5597970337"><img src="../assets/sina-weibo (1).svg"></a>
              </li>
              <li>
                <a class="dribbble" href="https://space.bilibili.com/404614050?spm_id_from=333.1007.0.0"><img src="../assets/bilibili.svg"></a>
              </li>
...
export default {
  ...
  data() {
    return {
      footer: [],
      icp: "Copyright @ 2022 |京 ICP 备 0000",
    };
  },
  created() {
